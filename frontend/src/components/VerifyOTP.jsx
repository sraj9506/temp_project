...
const VerifyOTP = () => {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      const res = await axios.post(`http://3.110.179.216:5000/api/auth/verify-otp`, { userId, otp });
  ...
  const handleResendOTP = async (e) => {
    ...
    try {
      const res = await axios.post(`http://3.110.179.216:5000/api/auth/resend-otp`, { userId });
